...
const explore = subCounts['mcp__codegraph__zcodegraph_explore'] || mainCounts['mcp__codegraph__zcodegraph_explore'] || 0;
...
console.log(`\nVERDICT: zcodegraph_explore used ${explore}x | Read ${reads} | Grep/Bash ${greps}`);
