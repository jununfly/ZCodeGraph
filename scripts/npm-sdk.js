'use strict';
//
// Programmatic / embedded SDK entry for @jununfly/zcodegraph (issue #354).
//
...
function resolveLibrary() {
  ...
  throw new Error(
    ...
    '      npm i @jununfly/zcodegraph --registry=https://registry.npmjs.org\n' +
    '  - or run the CLI once (e.g. `npx @jununfly/zcodegraph status`) to\n' +
