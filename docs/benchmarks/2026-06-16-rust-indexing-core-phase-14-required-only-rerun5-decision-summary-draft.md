...
- TypeScript: graph available; stats: {"fileCount":286,"nodeCount":4120,"edgeCount":17483,"nodeKinds":{"class":60,"constant":466,"file":286,"function":1080,"import":1190,"interface":165,"method":811,"property":2,"type_alias":35,"variable":25},"edgeKinds":{"calls":7528,"contains":3834,"extends":8,"implements":21,"imports":2890,"instantiates":410,"references":2792},"dbSizeBytes":17231872}
- Rust: graph available; stats: {"fileCount":286,"nodeCount":14038,"edgeCount":30977,"nodeKinds":{"class":59,"constant":7889,"export":50,"field":233,"file":286,"function":2382,"import":1186,"interface":165,"method":721,"type_alias":38,"variable":1029},"edgeKinds":{"calls":14498,"contains":13752,"exports":186,"imports":2360,"instantiates":181},"dbSizeBytes":23941120}
...
Totals: files 286 → 286 (0); nodes 4120 → 14038 (+9918); edges 17483 → 30977 (+13494).
...
|---|---:|---:|---:|
| class | 60 | 59 | -1 |
| constant | 466 | 7889 | +7423 |
| export | 0 | 50 | +50 |
| field | 0 | 233 | +233 |
| file | 286 | 286 | 0 |
| function | 1080 | 2382 | +1302 |
| import | 1190 | 1186 | -4 |
| interface | 165 | 165 | 0 |
| method | 811 | 721 | -90 |
| property | 2 | 0 | -2 |
...
| Kind | TypeScript | Rust | Delta |
|---|---:|---:|---:|
| calls | 7528 | 14498 | +6970 |
| contains | 3834 | 13752 | +9918 |
| exports | 0 | 186 | +186 |
| extends | 8 | 0 | -8 |
| implements | 21 | 0 | -21 |
...
- zcodegraph: wallTimeDeltaPct=12.772458749236096, peakRssDeltaPct=4.176610978520286
- excalidraw: wallTimeDeltaPct=2.8669367404175756, peakRssDeltaPct=-9.967532467532468

## Wall-time diagnostics

| Target | Arm | Source copy ms | Init ms | Index ms | Graph stats ms | Total ms |
|---|---|---:|---:|---:|---:|---:|
| zcodegraph | typescript | 201 | 4683 | 4934 | 72 | 9818 |
| zcodegraph | rust | 194 | 4612 | 6266 | 76 | 11072 |
| excalidraw | typescript | 518 | 12256 | 12898 | 75 | 25672 |
| excalidraw | rust | 449 | 12137 | 13822 | 74 | 26408 |
...
| zcodegraph | parseExtractionMs | 1381 |
| zcodegraph | sqliteWriteMs | 2622 |
| zcodegraph | subprocessStartupHandoffMs | 26 |
| zcodegraph | frameworkPostExtractMs | 9 |
| zcodegraph | referenceResolutionMs | 1194 |
| zcodegraph | dynamicDispatchSynthesisMs | 329 |
| zcodegraph | dbMaintenanceMs | 17 |
| zcodegraph | typescriptFinalizationMs | 1551 |
| excalidraw | sourceScanMs | 5 |
| excalidraw | parseExtractionMs | 2283 |
| excalidraw | sqliteWriteMs | 4184 |
| excalidraw | subprocessStartupHandoffMs | 26 |
| excalidraw | frameworkPostExtractMs | 15 |
| excalidraw | referenceResolutionMs | 5754 |
| excalidraw | dynamicDispatchSynthesisMs | 444 |
| excalidraw | dbMaintenanceMs | 30 |
| excalidraw | typescriptFinalizationMs | 6246 |
