...
Experiment: rust-indexing-core-phase-15f-borrowed-id-vscode-after
Manifest: docs/benchmarks/2026-06-17-rust-indexing-core-phase-15f-borrowed-id-vscode-after.experiment.json
...
- vscode: wallTimeDeltaPct=-24.543284068308072, peakRssDeltaPct=31.10236220472441

## Wall-time diagnostics

| Target | Arm | Source copy ms | Init ms | Index ms | Graph stats ms | Total ms |
|---|---|---:|---:|---:|---:|---:|
| vscode | typescript | 2649 | 214687 | 249256 | 115 | 466592 |
| vscode | rust | 2956 | 211862 | 137257 | 47 | 352075 |

## Rust index profile breakdown

| Target | Phase | Duration ms |
|---|---|---:|
| vscode | sourceScanMs | 101 |
| vscode | parseExtractionMs | 35736 |
| vscode | sqliteWriteMs | 61108 |
| vscode | subprocessStartupHandoffMs | 548 |
| vscode | frameworkPostExtractMs | 43 |
| vscode | referenceResolutionMs | 21111 |
| vscode | dynamicDispatchSynthesisMs | 6900 |
| vscode | dbMaintenanceMs | 40 |
| vscode | typescriptFinalizationMs | 28099 |
