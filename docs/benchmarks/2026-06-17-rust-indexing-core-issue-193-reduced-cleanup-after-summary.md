...
Experiment: rust-indexing-core-issue-193-reduced-cleanup-after
Manifest: docs/benchmarks/2026-06-17-rust-indexing-core-issue-193-reduced-cleanup-after.experiment.json
...
- phase18-reduced: wallTimeDeltaPct=-4.00200100050025, peakRssDeltaPct=1.1699707507312318

## Wall-time diagnostics

| Target | Arm | Source copy ms | Init ms | Index ms | Graph stats ms | Total ms |
|---|---|---:|---:|---:|---:|---:|
| phase18-reduced | typescript | 43 | 845 | 1110 | 19 | 1999 |
| phase18-reduced | rust | 11 | 794 | 1114 | 20 | 1919 |
...
| phase18-reduced | sqliteWriteMs | 539 |
| phase18-reduced | importPathAliasResolutionMs | 20 |
...
| phase18-reduced | referenceResolutionMs | 16 |
| phase18-reduced | dynamicDispatchSynthesisMs | 20 |
| phase18-reduced | dbMaintenanceMs | 4 |
| phase18-reduced | typescriptFinalizationMs | 44 |
...
| phase18-reduced | Rust SQLite write | 539 | measured |
| phase18-reduced | Rust subprocess startup/handoff | 3 | measured |
| phase18-reduced | TypeScript finalization | 44 | measured |
| phase18-reduced | Reference resolution | 16 | measured |
| phase18-reduced | Dynamic-dispatch synthesis | 20 | measured |
| phase18-reduced | DB maintenance | 4 | measured |
| phase18-reduced | graphStats measurement | 20 | measured |
