...
Experiment: rust-indexing-core-phase-15f-production-like-vscode-baseline
Manifest: docs/benchmarks/2026-06-17-rust-indexing-core-phase-15f-production-like-vscode-baseline.experiment.json
...
- vscode: wallTimeDeltaPct=-22.306241902393943, peakRssDeltaPct=30.451756832124932

## Wall-time diagnostics

| Target | Arm | Source copy ms | Init ms | Index ms | Graph stats ms | Total ms |
|---|---|---:|---:|---:|---:|---:|
| vscode | typescript | 2731 | 214185 | 240781 | 73 | 457697 |
| vscode | rust | 3008 | 211605 | 140989 | 50 | 355602 |

## Rust index profile breakdown

| Target | Phase | Duration ms |
|---|---|---:|
| vscode | sourceScanMs | 99 |
| vscode | parseExtractionMs | 37195 |
| vscode | sqliteWriteMs | 62635 |
| vscode | subprocessStartupHandoffMs | 558 |
| vscode | frameworkPostExtractMs | 45 |
| vscode | referenceResolutionMs | 21549 |
| vscode | dynamicDispatchSynthesisMs | 6929 |
| vscode | dbMaintenanceMs | 57 |
| vscode | typescriptFinalizationMs | 28599 |
