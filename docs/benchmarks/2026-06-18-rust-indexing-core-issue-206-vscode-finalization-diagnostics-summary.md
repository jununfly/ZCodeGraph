...
Experiment: rust-indexing-core-issue-206-vscode-finalization-diagnostics
Manifest: docs/benchmarks/2026-06-18-rust-indexing-core-issue-206-vscode-finalization-diagnostics.experiment.json
...
- vscode: wallTimeDeltaPct=24.62865556747837, peakRssDeltaPct=2.8153564899451555

## Wall-time diagnostics

| Target | Arm | Source copy ms | Init ms | Index ms | Graph stats ms | Total ms |
|---|---|---:|---:|---:|---:|---:|
| vscode | typescript | 1702 | 219428 | 234579 | 66 | 455709 |
| vscode | rust | 2631 | 216102 | 349211 | 78 | 567944 |

## Rust index profile breakdown

| Target | Phase | Duration ms |
|---|---|---:|
| vscode | sourceScanMs | 110 |
| vscode | parseExtractionMs | 38964 |
| vscode | sqliteWriteMs | 132096 |
| vscode | importPathAliasResolutionMs | 5764 |
...
| vscode | esmNamedImportExportResolutionMs | 12787 |
...
| vscode | localExactReferenceResolutionMs | 49450 |
...
| vscode | referenceResolutionMs | 85127 |
| vscode | dynamicDispatchSynthesisMs | 9374 |
| vscode | dbMaintenanceMs | 114 |
| vscode | typescriptFinalizationMs | 98005 |
...
|---|---|---:|---|
| vscode | Rust source scan | 110 | measured |
| vscode | Rust parse extraction | 38964 | measured |
| vscode | Rust SQLite write | 132096 | measured |
| vscode | Rust subprocess startup/handoff | 4 | measured |
| vscode | TypeScript finalization | 98005 | measured |
| vscode | Reference resolution | 85127 | measured |
| vscode | Dynamic-dispatch synthesis | 9374 | measured |
| vscode | DB maintenance | 114 | measured |
| vscode | graphStats measurement | 78 | measured |
