...
Experiment: rust-indexing-core-issue-205-vscode-finalization-profile
...
- vscode: wallTimeDeltaPct=25.80552219832232, peakRssDeltaPct=-12.685337726523887

## Wall-time diagnostics

| Target | Arm | Source copy ms | Init ms | Index ms | Graph stats ms | Total ms |
|---|---|---:|---:|---:|---:|---:|
| vscode | typescript | 2555 | 217047 | 235072 | 67 | 454674 |
| vscode | rust | 2792 | 213315 | 355898 | 75 | 572005 |
...
| vscode | parseExtractionMs | 39032 |
| vscode | sqliteWriteMs | 138150 |
| vscode | importPathAliasResolutionMs | 6160 |
...
| vscode | esmNamedImportExportResolutionMs | 13131 |
...
| vscode | localExactReferenceResolutionMs | 48582 |
...
| vscode | referenceResolutionMs | 85884 |
| vscode | dynamicDispatchSynthesisMs | 9422 |
| vscode | dbMaintenanceMs | 108 |
| vscode | typescriptFinalizationMs | 98673 |
...
| vscode | Rust parse extraction | 39032 | measured |
| vscode | Rust SQLite write | 138150 | measured |
| vscode | Rust subprocess startup/handoff | 13 | measured |
| vscode | TypeScript finalization | 98673 | measured |
| vscode | Reference resolution | 85884 | measured |
| vscode | Dynamic-dispatch synthesis | 9422 | measured |
| vscode | DB maintenance | 108 | measured |
| vscode | graphStats measurement | 75 | measured |
