...
Rust core: available (C:/workspace/github/jununfly/ZCodeGraph/target/debug/zcodegraph-core.exe)
...
- vscode: wallTimeDeltaPct=-26.44218920452483, peakRssDeltaPct=20.075017582245838

## Wall-time diagnostics

| Target | Arm | Source copy ms | Init ms | Index ms | Graph stats ms | Total ms |
|---|---|---:|---:|---:|---:|---:|
| vscode | typescript | 7034 | 499731 | 540080 | 181 | 1046846 |
| vscode | rust | 7037 | 503590 | 259410 | 134 | 770037 |

## Rust index profile breakdown

| Target | Phase | Duration ms |
|---|---|---:|
| vscode | sourceScanMs | 128 |
| vscode | parseExtractionMs | 49799 |
| vscode | sqliteWriteMs | 66991 |
| vscode | subprocessStartupHandoffMs | 38 |
| vscode | frameworkPostExtractMs | 91 |
| vscode | referenceResolutionMs | 110970 |
| vscode | dynamicDispatchSynthesisMs | 16922 |
| vscode | dbMaintenanceMs | 228 |
| vscode | typescriptFinalizationMs | 128235 |
