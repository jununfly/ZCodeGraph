 ...
 * single dotted-key table block (`[mcp_servers.zcodegraph]`) inside an
 ...
 *
 * Strategy: treat the file as text. Find the `[mcp_servers.zcodegraph]`
 ...
 *     the full dotted key `[mcp_servers.zcodegraph]`).
